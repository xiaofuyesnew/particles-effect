...
import { VerticesDuplicateRemove } from '@/utils'
...
export class ParticleSystem {
  ...
  _addModels() {
    ...
    this.Models.forEach((i) => {
      ...
      const finishLoad = () => {
        ...
        this._LOAD_COUNT_++
        // 所有模型加载完后触发播放事件
        if (this._LOAD_COUNT_ === this.Models.size)
          this._finishLoadModal()
      }
  ...
  _finishLoadModal() {
    ...
    // 开始监听鼠标移动事件
    // 钩子
    this.onModelsFinishedLoad(this.AnimateEffectParticle, this.scene)
  }
